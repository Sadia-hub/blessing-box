...
function WhyChooseUs() {
    ...
    return (<>
        ...
        <Row>
            <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 12 }} lg={{ span: 9 }} offset={2}>
                <Title level={5} className={styles.text} >It is a social service platform that invites multiple Pakistani Non-government Organizations
            ...
            <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 12 }} lg={{ span: 8 }} offset={3}>
                <Image height={350}
                    width={350}
                    src="/whyChooseUs.png"
